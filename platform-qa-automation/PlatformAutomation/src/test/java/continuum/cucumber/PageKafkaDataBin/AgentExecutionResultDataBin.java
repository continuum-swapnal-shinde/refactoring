...
public class AgentExecutionResultDataBin {
		...
		public AgentExecutionResultDataBin setMessage(Object message) {
		...
		public AgentExecutionResultDataBin setHeader(Object header) {
	        this.header = header;
	        return this;
	    }
	    ...
	    public boolean equals(Object o) {
	        ...
	        if (!(o instanceof AgentExecutionResultDataBin)) return false;

	        AgentExecutionResultDataBin that = (AgentExecutionResultDataBin) o;
