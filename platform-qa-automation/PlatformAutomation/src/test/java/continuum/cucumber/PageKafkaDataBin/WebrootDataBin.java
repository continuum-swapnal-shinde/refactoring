...
public class WebrootDataBin {
    ...
    public WebrootDataBin setAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public WebrootDataBin setTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public WebrootDataBin setRegID(String regID) {
        this.regID = regID;
        return this;
    }
    ...
    public WebrootDataBin setLegacyRegID(String legacyRegID) {
    ...
    public WebrootDataBin setDcDateTimeUtc(String dcDateTimeUtc) {
    ...
    public WebrootDataBin setPartnerID(String partnerID) {
    ...
    public WebrootDataBin setClientID(String clientID) {
    ...
    public WebrootDataBin setSiteID(String siteID) {
        this.siteID = siteID;
        return this;
    }
    ...
    public WebrootDataBin setEndpointID(String endpointID) {
    ...
    public WebrootDataBin setAgentID(String agentID) {
    ...
    public WebrootDataBin setRemoteAddr(String remoteAddr) {
    ...
    public WebrootDataBin setTransactionID(String transactionID) {
    ...
    public WebrootDataBin setMessage(Object message) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebrootDataBin)) return false;

        WebrootDataBin that = (WebrootDataBin) o;
